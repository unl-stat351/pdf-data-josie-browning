...
> 2.  Group by page number (number of nested list that each group came from)
...
```{r} 
data <- pdf_data("pdf_files/unl-department-budget-2025-2026.pdf")

df <- bind_rows(data, .id = "page")
```
